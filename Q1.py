...
CHROM_LEN = 80         # 2) length of individuals
N_GENERATIONS = 50     # 3) number of generations
TARGET_ONES = 40       # 4) optimum at ones == 40
MAX_FITNESS = 80       # 5) return value is 80 when ones == 40
...
# ---- Streamlit UI ----
st.set_page_config(
    page_title="Bit Pattern GA (80 bits, target ones = 40)",
    page_icon="🧬",
    layout="centered"
)
...
with st.expander("Problem setup", expanded=True):
    st.write(
        f"""
